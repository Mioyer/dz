  ...
  <div class="main">
    ...
    <div class="content-box">
      ...
      >
        ...
        <el-table-column prop="useraccount" label="登录用户名" align="center" min-width="100"></el-table-column>
        <el-table-column prop="realName" label="真实姓名" align="center" min-width="100"></el-table-column>
        <el-table-column prop="mobile" label="手机号" align="center" min-width="150"></el-table-column>
        <el-table-column prop="createtime" label="创建时间" align="center" min-width="160"></el-table-column>
        <el-table-column prop="rolesArr" label="所属岗位" align="center" min-width="160"></el-table-column>
